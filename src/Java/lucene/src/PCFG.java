...
public class PCFG {
	...
	/**
	 * Create a new probabilistic context-free grammar.
	 *
	 */
	public PCFG () {
	...
	/**
	 * Load previously derived PCFG.
	 * @param filename File containing rules and weights
	 * @return The loaded PCFG
	 * @throws IOException
	 */
	...
	/**
	 * Add a set of lexical rules to the pcfg.
